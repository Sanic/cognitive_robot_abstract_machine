...
def scale_camera_intrinsics(annotator: BaseAnnotator) -> None:
    ...
    the depth image has. This also requires an adjustment of the camera intrinsics.

    If color2depth ratio is not 1,1, we'll scale the camera intrinsics in annotator.
    You need to have a self.camera_intrinsics variable!
